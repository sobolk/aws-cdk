...
process.on('exit', () => {
    ...
    console.log('\n✨  Testapp002 total processing time: %ss\n', globalElapsedTime/1000);
    console.log('\n✨  Testapp002 processing time no imports: %ss\n', noImportsElapsedTime/1000);
});

const app = new cdk.App();
new Testapp002Stack(app, 'Testapp002Stack', {
