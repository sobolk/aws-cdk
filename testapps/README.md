...
The `testapp012` is a copy of `testapp003` but is attempting to run `tsc --incremental` instead of `ts-node` and then use `.js` files to deploy.

This configuration preserves type checking.

### testapp013

The `testapp013` is a copy of `testapp003` but is using `tsx` instead of `ts-node`.

This configuration disables type checking. https://github.com/esbuild-kit/tsx#does-it-do-type-checking.
...
| Measurement                    | testapp001 basic | testapp001 no IPC | testapp001 extra IPC | testapp001 extra no IPC | testapp002 basic | testapp002 no IPC | testapp002 extra IPC | testapp002 extra no IPC | testapp003      | testapp004      | testapp005      | testapp006      | testapp007      | testapp008      | testapp009      | testapp010      | testapp011      | testapp012      | testapp013      |
|--------------------------------|------------------|-------------------|----------------------|-------------------------|------------------|-------------------|----------------------|-------------------------|-----------------|-----------------|-----------------|-----------------|-----------------|-----------------|-----------------|-----------------|-----------------|-----------------|-----------------|
| Stack all imports              | 0.122&pm;0.012s  | 0.117&pm;0.004s   | 0.111&pm;0.002s      | 0.117&pm;0.004s         | 0.113&pm;0.003s  | 0.112&pm;0.003s   | 0.112&pm;0.003s      | 0.112&pm;0.003s         | 0.071&pm;0.014s | 0.076&pm;0.014s | 0.123&pm;0.021s | 0.117&pm;0.022s | 0.001&pm;0.001s | 0.000&pm;0.000s | 0.001&pm;0.001s | 0.068&pm;0.009s | 0.065&pm;0.002s | 0.072&pm;0.010s | 0.001&pm;0.000s |
| App all imports                | 0.307&pm;0.026s  | 0.286&pm;0.006s   | 0.285&pm;0.002s      | 0.284&pm;0.007s         | 0.260&pm;0.005s  | 0.240&pm;0.005s   | 0.258&pm;0.007s      | 0.242&pm;0.008s         | 0.218&pm;0.033s | 0.208&pm;0.032s | 0.219&pm;0.036s | 0.197&pm;0.036s | 0.581&pm;0.004s | 0.591&pm;0.063s | 0.000&pm;0.000s | 0.211&pm;0.020s | 0.202&pm;0.003s | 0.204&pm;0.024s | 0.000&pm;0.000s |
| Stage.synth()                  | 0.037&pm;0.003s  | 0.031&pm;0.001s   | 0.035&pm;0.002s      | 0.033&pm;0.002s         | 0.035&pm;0.001s  | 0.031&pm;0.001s   | 0.035&pm;0.001s      | 0.032&pm;0.001s         | N/A             | N/A             | N/A             | N/A             | N/A             | N/A             | N/A             | N/A             | N/A             | N/A             | N/A             |
| Synth from CLI side            | 4.449&pm;0.108s  | 0.032&pm;0.001s   | 4.260&pm;0.019s      | 0.033&pm;0.002s         | 0.371&pm;0.010s  | 0.031&pm;0.001s   | 0.366&pm;0.010s      | 0.032&pm;0.001s         | N/A             | N/A             | N/A             | N/A             | N/A             | N/A             | N/A             | N/A             | N/A             | N/A             | N/A             |
| App total processing time      | 0.362&pm;0.028s  | 0.428&pm;0.008s   | 0.335&pm;0.003s      | 0.425&pm;0.012s         | 0.311&pm;0.006s  | 0.372&pm;0.007s   | 0.308&pm;0.009s      | 0.378&pm;0.012s         | 0.268&pm;0.035s | 0.259&pm;0.034s | 0.315&pm;0.038s | 0.263&pm;0.039s | 0.630&pm;0.004s | 0.639&pm;0.063s | 0.050&pm;0.002s | 0.260&pm;0.020s | 0.250&pm;0.004s | 0.253&pm;0.025s | 0.050&pm;0.002s |
| App processing time no imports | 0.055&pm;0.004s  | 0.143&pm;0.005s   | 0.050&pm;0.002s      | 0.141&pm;0.005s         | 0.051&pm;0.001s  | 0.132&pm;0.004s   | 0.050&pm;0.002s      | 0.136&pm;0.005s         | 0.050&pm;0.003s | 0.050&pm;0.002s | 0.097&pm;0.005s | 0.065&pm;0.003s | 0.049&pm;0.001s | 0.048&pm;0.001s | 0.050&pm;0.002s | 0.049&pm;0.001s | 0.048&pm;0.001s | 0.049&pm;0.001s | 0.050&pm;0.001s |
| real                           | 5.088&pm;0.172s  | 6.713&pm;0.098s   | 5.454&pm;0.035s      | 6.623&pm;0.123s         | 0.968&pm;0.013s  | 0.891&pm;0.031s   | 0.996&pm;0.015s      | 0.892&pm;0.026s         | 2.783&pm;0.222s | 0.915&pm;0.045s | 5.306&pm;0.297s | 3.978&pm;0.071s | 3.070&pm;0.018s | 1.276&pm;0.070s | 1.294&pm;0.125s | 1.305&pm;0.146s | 2.660&pm;0.012s | 2.849&pm;0.176s | 1.565&pm;0.053s |
| user                           | 7.453&pm;0.080s  | 9.587&pm;0.123s   | 8.577&pm;0.081s      | 9.513&pm;0.128s         | 0.955&pm;0.007s  | 0.906&pm;0.016s   | 0.975&pm;0.014s      | 0.903&pm;0.018s         | 3.939&pm;0.134s | 0.881&pm;0.026s | 6.000&pm;0.080s | 3.746&pm;0.047s | 4.278&pm;0.013s | 1.238&pm;0.014s | 1.199&pm;0.019s | 1.228&pm;0.019s | 3.875&pm;0.032s | 4.053&pm;0.072s | 1.469&pm;0.030s |
| sys                            | 0.817&pm;0.018s  | 1.138&pm;0.027s   | 0.823&pm;0.015s      | 1.127&pm;0.045s         | 0.176&pm;0.005s  | 0.166&pm;0.010s   | 0.172&pm;0.004s      | 0.168&pm;0.009s         | 0.411&pm;0.040s | 0.131&pm;0.007s | 0.935&pm;0.099s | 0.711&pm;0.019s | 0.479&pm;0.007s | 0.193&pm;0.007s | 0.213&pm;0.025s | 0.192&pm;0.021s | 0.394&pm;0.005s | 0.424&pm;0.037s | 0.257&pm;0.016s |

#### hotswap all scenarios

| Measurement                    | testapp001 basic | testapp001 no IPC | testapp001 extra IPC | testapp001 extra no IPC | testapp002 basic | testapp002 no IPC | testapp002 extra IPC | testapp002 extra no IPC | testapp003      | testapp004      | testapp005      | testapp006      | testapp007      | testapp008      | testapp009      | testapp010      | testapp011      | testapp012      | testapp013      |
|--------------------------------|------------------|-------------------|----------------------|-------------------------|------------------|-------------------|----------------------|-------------------------|-----------------|-----------------|-----------------|-----------------|-----------------|-----------------|-----------------|-----------------|-----------------|-----------------|-----------------|
| Stack all imports              | 0.115&pm;0.002s  | 0.121&pm;0.004s   | 0.114&pm;0.003s      | 0.118&pm;0.003s         | 0.112&pm;0.004s  | 0.114&pm;0.004s   | 0.110&pm;0.002s      | 0.112&pm;0.002s         | 0.069&pm;0.007s | 0.073&pm;0.005s | 0.111&pm;0.006s | 0.109&pm;0.003s | 0.001&pm;0.001s | 0.000&pm;0.000s | 0.001&pm;0.000s | 0.066&pm;0.003s | 0.064&pm;0.002s | 0.073&pm;0.012s | 0.001&pm;0.001s |
| App all imports                | 0.294&pm;0.003s  | 0.294&pm;0.008s   | 0.292&pm;0.003s      | 0.288&pm;0.006s         | 0.258&pm;0.010s  | 0.246&pm;0.007s   | 0.257&pm;0.004s      | 0.243&pm;0.004s         | 0.216&pm;0.020s | 0.213&pm;0.033s | 0.199&pm;0.007s | 0.185&pm;0.006s | 0.580&pm;0.006s | 0.568&pm;0.010s | 0.000&pm;0.000s | 0.206&pm;0.006s | 0.203&pm;0.004s | 0.208&pm;0.027s | 0.000&pm;0.000s |
| Stage.synth()                  | 0.036&pm;0.002s  | 0.032&pm;0.001s   | 0.037&pm;0.003s      | 0.031&pm;0.001s         | 0.035&pm;0.002s  | 0.032&pm;0.001s   | 0.035&pm;0.001s      | 0.032&pm;0.001s         | N/A             | N/A             | N/A             | N/A             | N/A             | N/A             | N/A             | N/A             | N/A             | N/A             | N/A             |
| Synth from CLI side            | 4.392&pm;0.050s  | 0.032&pm;0.001s   | 4.397&pm;0.055s      | 0.031&pm;0.001s         | 0.369&pm;0.013s  | 0.033&pm;0.001s   | 0.365&pm;0.008s      | 0.033&pm;0.001s         | N/A             | N/A             | N/A             | N/A             | N/A             | N/A             | N/A             | N/A             | N/A             | N/A             | N/A             |
| App total processing time      | 0.346&pm;0.004s  | 2.251&pm;0.123s   | 0.344&pm;0.004s      | 2.295&pm;0.124s         | 0.310&pm;0.013s  | 1.839&pm;0.167s   | 0.308&pm;0.004s      | 1.802&pm;0.120s         | 0.270&pm;0.026s | 0.265&pm;0.037s | 0.297&pm;0.012s | 0.248&pm;0.007s | 0.629&pm;0.007s | 0.616&pm;0.010s | 0.048&pm;0.001s | 0.255&pm;0.008s | 0.252&pm;0.005s | 0.257&pm;0.028s | 0.049&pm;0.002s |
| App processing time no imports | 0.052&pm;0.002s  | 1.956&pm;0.128s   | 0.052&pm;0.003s      | 2.007&pm;0.122s         | 0.052&pm;0.004s  | 1.594&pm;0.165s   | 0.051&pm;0.002s      | 1.559&pm;0.121s         | 0.054&pm;0.007s | 0.052&pm;0.004s | 0.099&pm;0.006s | 0.063&pm;0.002s | 0.050&pm;0.001s | 0.048&pm;0.002s | 0.048&pm;0.001s | 0.049&pm;0.002s | 0.049&pm;0.002s | 0.049&pm;0.002s | 0.049&pm;0.002s |
| Synthesis time                 | 4.404&pm;0.051s  | 0.043&pm;0.005s   | 4.409&pm;0.056s      | 0.041&pm;0.003s         | 0.380&pm;0.012s  | 0.041&pm;0.003s   | 0.375&pm;0.008s      | 0.040&pm;0.000s         | 2.241&pm;0.120s | 0.341&pm;0.039s | 1.505&pm;0.025s | 0.329&pm;0.009s | 2.524&pm;0.032s | 0.692&pm;0.010s | 0.658&pm;0.008s | 0.718&pm;0.017s | 2.105&pm;0.013s | 2.274&pm;0.081s | 0.962&pm;0.015s |
| Deployment time                | 0.614&pm;0.018s  | 0.626&pm;0.023s   | 0.655&pm;0.102s      | 0.624&pm;0.019s         | 0.230&pm;0.036s  | 0.224&pm;0.022s   | 0.221&pm;0.012s      | 0.223&pm;0.016s         | 0.447&pm;0.032s | 0.485&pm;0.073s | 0.429&pm;0.032s | 0.405&pm;0.036s | 0.228&pm;0.052s | 0.228&pm;0.052s | 0.414&pm;0.015s | 0.435&pm;0.025s | 0.413&pm;0.020s | 0.437&pm;0.022s | 0.421&pm;0.016s |
| Total time                     | 5.018&pm;0.054s  | 0.669&pm;0.023s   | 5.063&pm;0.108s      | 0.664&pm;0.019s         | 0.611&pm;0.037s  | 0.268&pm;0.023s   | 0.594&pm;0.020s      | 0.265&pm;0.018s         | 2.687&pm;0.129s | 0.824&pm;0.079s | 1.935&pm;0.039s | 0.734&pm;0.039s | 2.753&pm;0.047s | 0.920&pm;0.052s | 1.072&pm;0.018s | 1.152&pm;0.034s | 2.518&pm;0.026s | 2.713&pm;0.085s | 1.382&pm;0.026s |
| real                           | 6.849&pm;0.100s  | 8.560&pm;0.101s   | 7.523&pm;0.111s      | 8.536&pm;0.157s         | 2.483&pm;0.127s  | 2.375&pm;0.171s   | 2.486&pm;0.116s      | 2.340&pm;0.112s         | 4.699&pm;0.420s | 2.705&pm;0.227s | 6.061&pm;0.111s | 4.806&pm;0.066s | 4.472&pm;0.120s | 2.640&pm;0.105s | 2.896&pm;0.077s | 3.021&pm;0.166s | 4.309&pm;0.140s | 4.543&pm;0.125s | 3.158&pm;0.100s |
| user                           | 8.095&pm;0.056s  | 10.352&pm;0.094s  | 9.475&pm;0.077s      | 10.332&pm;0.147s        | 1.437&pm;0.031s  | 1.373&pm;0.033s   | 1.461&pm;0.032s      | 1.375&pm;0.022s         | 4.550&pm;0.141s | 1.375&pm;0.049s | 6.279&pm;0.070s | 4.061&pm;0.055s | 4.732&pm;0.049s | 1.686&pm;0.031s | 1.641&pm;0.019s | 1.691&pm;0.041s | 4.342&pm;0.026s | 4.615&pm;0.099s | 1.938&pm;0.037s |
| sys                            | 0.864&pm;0.010s  | 1.254&pm;0.050s   | 0.941&pm;0.009s      | 1.194&pm;0.034s         | 0.226&pm;0.008s  | 0.233&pm;0.008s   | 0.238&pm;0.006s      | 0.235&pm;0.005s         | 0.487&pm;0.040s | 0.196&pm;0.024s | 0.928&pm;0.015s | 0.736&pm;0.027s | 0.522&pm;0.006s | 0.239&pm;0.010s | 0.242&pm;0.006s | 0.235&pm;0.012s | 0.436&pm;0.005s | 0.489&pm;0.024s | 0.289&pm;0.010s |

**Observations**

1. Assets staging and synthesis happen in CDK App. CDK CLI spawns child process where CDK App runs both.
2. Neither asset staging nor synthesis algorithm is a bottleneck. They complete under 0.05s.
3. Most time is lost in IPC call, spawning new Node process, loading and compiling Typescript code.
4. For single deployment, the tax related to loading and compiling Typescript is not avoidable. It has to happen at some point of the process.
...
1. JS synthesis time is sub 0.5s from CDK CLI point of view. This indicates that compiling Typescript is main contributor to perceived synthesis speed in Typescript apps.
...
1. CDK V1 was not a monolithic library. This experiment confirms that bundling CDK into single lib is not a problem.
...
1. For single deployment, the tax related to loading and compiling Typescript is not avoidable. It has to happen at some point of the process.
2. Typescript benchmark is a bit skewed - we're also loading CDK CLI for testing purposes.
...
1. Initial change caused regression. I.e. longer times.
...
1. `testapp004` is pure JS CDK app. Included as baseline for comparisons.
2. `testapp003` uses defaults generated by `cdk init app --language typescript`
3. `testapp009` uses `@swc/core` compiler written in Rust. This disables type checking.
4. `testapp010` uses `transpileOnly` flag. This disables type checking.
5. `testapp011` uses `--files` and `skipLibCheck` flags. This preserves type checking.
6. `testapp012` uses `tsc --incremental` and `.js` files to deploy. This preserves type checking.
7. `testapp013` uses `tsx` instead of `ts-node`. This disables type checking.

##### hotswap

| Measurement                    | testapp004 (JS) | testapp003 (CDK defaults, type checking on) | testapp009 (`@swc/core` compiler, type checking off) | testapp010 (`transpileOnly` flag, type checking off) | testapp011 ( `--files` and `skipLibCheck` flags, type checking on) | testapp012 ( `tsc --incremental`, type checking on) | testapp013 ( `tsx`, type checking off) |
|--------------------------------|-----------------|---------------------------------------------|------------------------------------------------------|------------------------------------------------------|--------------------------------------------------------------------|-----------------------------------------------------|----------------------------------------|
| Stack all import               | 0.073&pm;0.005s | 0.069&pm;0.007s                             | 0.001&pm;0.000s                                      | 0.066&pm;0.003s                                      | 0.064&pm;0.002s                                                    | 0.073&pm;0.012s                                     | 0.001&pm;0.001s                        |
| App all import                 | 0.213&pm;0.033s | 0.216&pm;0.020s                             | 0.000&pm;0.000s                                      | 0.206&pm;0.006s                                      | 0.203&pm;0.004s                                                    | 0.208&pm;0.027s                                     | 0.000&pm;0.000s                        |
| App total processing time      | 0.265&pm;0.037s | 0.270&pm;0.026s                             | 0.048&pm;0.001s                                      | 0.255&pm;0.008s                                      | 0.252&pm;0.005s                                                    | 0.257&pm;0.028s                                     | 0.049&pm;0.002s                        |
| App processing time no imports | 0.052&pm;0.004s | 0.054&pm;0.007s                             | 0.048&pm;0.001s                                      | 0.049&pm;0.002s                                      | 0.049&pm;0.002s                                                    | 0.049&pm;0.002s                                     | 0.049&pm;0.002s                        |
| Synthesis time                 | 0.341&pm;0.039s | 2.241&pm;0.120s                             | 0.658&pm;0.008s                                      | 0.718&pm;0.017s                                      | 2.105&pm;0.013s                                                    | 2.274&pm;0.081s                                     | 0.962&pm;0.015s                        |
| Deployment time                | 0.485&pm;0.073s | 0.447&pm;0.032s                             | 0.414&pm;0.015s                                      | 0.435&pm;0.025s                                      | 0.413&pm;0.020s                                                    | 0.437&pm;0.022s                                     | 0.421&pm;0.016s                        |
| Total time                     | 0.824&pm;0.079s | 2.687&pm;0.129s                             | 1.072&pm;0.018s                                      | 1.152&pm;0.034s                                      | 2.518&pm;0.026s                                                    | 2.713&pm;0.085s                                     | 1.382&pm;0.026s                        |
| real                           | 2.705&pm;0.227s | 4.699&pm;0.420s                             | 2.896&pm;0.077s                                      | 3.021&pm;0.166s                                      | 4.309&pm;0.140s                                                    | 4.543&pm;0.125s                                     | 3.158&pm;0.100s                        |
| user                           | 1.375&pm;0.049s | 4.550&pm;0.141s                             | 1.641&pm;0.019s                                      | 1.691&pm;0.041s                                      | 4.342&pm;0.026s                                                    | 4.615&pm;0.099s                                     | 1.938&pm;0.037s                        |
| sys                            | 0.196&pm;0.024s | 0.487&pm;0.040s                             | 0.242&pm;0.006s                                      | 0.235&pm;0.012s                                      | 0.436&pm;0.005s                                                    | 0.489&pm;0.024s                                     | 0.289&pm;0.010s                        |

**Observation**

1. Disabling type checking brings down IPC style synthesis to pure JS levels.
...
1. Time saved by optimizing synthesis compounds when running multiple subsequent deployments that would only involve assets swaps.

### Typescript compiler diagnostics

Running `npx tsc --extendedDiagnostics` in `testapp012`. After adding `skipLibCheck` to `tsconfig.json`.

```
Files:                        1734
Lines of Library:            37475
Lines of Definitions:       513269
Lines of TypeScript:           122
