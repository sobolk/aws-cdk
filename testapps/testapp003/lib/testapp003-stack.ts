...
console.log('\n✨  Testapp003Stack import * as cdk from \'aws-cdk-lib\': %ss\n', singleImportElapsedTime/1000);
singleImportStartTime = new Date().getTime();
import { Construct } from 'constructs';
singleImportElapsedTime = new Date().getTime() - singleImportStartTime;
console.log('\n✨  Testapp003Stack import { Construct } from \'constructs\': %ss\n', singleImportElapsedTime/1000);
singleImportStartTime = new Date().getTime();
import * as s3 from 'aws-cdk-lib/aws-s3';
singleImportElapsedTime = new Date().getTime() - singleImportStartTime;
console.log('\n✨  Testapp003Stack import * as s3 from \'aws-cdk-lib/aws-s3\': %ss\n', singleImportElapsedTime/1000);
singleImportStartTime = new Date().getTime();
import * as lambda from 'aws-cdk-lib/aws-lambda'
singleImportElapsedTime = new Date().getTime() - singleImportStartTime;
console.log('\n✨  Testapp003Stack import * as lambda from \'aws-cdk-lib/aws-lambda\': %ss\n', singleImportElapsedTime/1000);
singleImportStartTime = new Date().getTime();
import * as s3deploy from 'aws-cdk-lib/aws-s3-deployment';
singleImportElapsedTime = new Date().getTime() - singleImportStartTime;
console.log('\n✨  Testapp003Stack import * as s3deploy from \'aws-cdk-lib/aws-s3-deployment\': %ss\n', singleImportElapsedTime/1000);
const importElapsedTime = new Date().getTime() - importStartTime;
console.log('\n✨  Testapp003Stack all import: %ss\n', importElapsedTime/1000);


export class Testapp003Stack extends cdk.Stack {
