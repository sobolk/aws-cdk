...
| Measurement                    | testapp004 (JS) | testapp003 (CDK defaults, type checking on) | testapp009 (`@swc/core` compiler, type checking off) | testapp010 (`transpileOnly` flag, type checking off) | testapp011 ( `--files` and `skipLibCheck` flags, type checking on) |
|--------------------------------|-----------------|---------------------------------------------|------------------------------------------------------|------------------------------------------------------|--------------------------------------------------------------------|
| Stack all import               | 0.073&pm;0.005s | 0.069&pm;0.007s                             | 0.001&pm;0.000s                                      | 0.066&pm;0.003s                                      | 0.064&pm;0.002s                                                    |
| App all import                 | 0.213&pm;0.033s | 0.216&pm;0.020s                             | 0.000&pm;0.000s                                      | 0.206&pm;0.006s                                      | 0.203&pm;0.004s                                                    |
| App total processing time      | 0.265&pm;0.037s | 0.270&pm;0.026s                             | 0.048&pm;0.001s                                      | 0.255&pm;0.008s                                      | 0.252&pm;0.005s                                                    |
| App processing time no imports | 0.052&pm;0.004s | 0.054&pm;0.007s                             | 0.048&pm;0.001s                                      | 0.049&pm;0.002s                                      | 0.049&pm;0.002s                                                    |
| Synthesis time                 | 0.341&pm;0.039s | 2.241&pm;0.120s                             | 0.658&pm;0.008s                                      | 0.718&pm;0.017s                                      | 2.105&pm;0.013s                                                    |
| Deployment time                | 0.485&pm;0.073s | 0.447&pm;0.032s                             | 0.414&pm;0.015s                                      | 0.435&pm;0.025s                                      | 0.413&pm;0.020s                                                    |
| Total time                     | 0.824&pm;0.079s | 2.687&pm;0.129s                             | 1.072&pm;0.018s                                      | 1.152&pm;0.034s                                      | 2.518&pm;0.026s                                                    |
| real                           | 2.705&pm;0.227s | 4.699&pm;0.420s                             | 2.896&pm;0.077s                                      | 3.021&pm;0.166s                                      | 4.309&pm;0.140s                                                    |
| user                           | 1.375&pm;0.049s | 4.550&pm;0.141s                             | 1.641&pm;0.019s                                      | 1.691&pm;0.041s                                      | 4.342&pm;0.026s                                                    |
| sys                            | 0.196&pm;0.024s | 0.487&pm;0.040s                             | 0.242&pm;0.006s                                      | 0.235&pm;0.012s                                      | 0.436&pm;0.005s                                                    |
